...
|---|---|---|---|
| 1. Foundation | `2026-07-07-phase-1-foundation.md` (ready) | Next.js 15 scaffold, full Prisma schema + migrations, tenant resolution from Host header, tenant-scoped Prisma client, secrets encryption, seed data, Google sign-in with tenant-scoped user provisioning, branded base layout | §2, §3, §6 (schema), part of §8 (layout) |
